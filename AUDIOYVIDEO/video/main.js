...
vol.oninput = function () {
    video.volume = vol.value / 100;
    if (vol.value == 0) {
        document.getElementById("Layer_1").innerHTML = '<path d="m12,16.242v7.77l-7.356-6.013h-2.644c-1.103,0-2-.897-2-2v-8c0-1.026.776-1.873,1.771-1.987l10.229,10.229Zm2,2.758v2h1c.543,0,1.082-.049,1.612-.145l-1.855-1.855h-.757Zm6.521.107l3.436,3.436-1.414,1.414L.043,1.457,1.457.043l4.717,4.717L12,.037v10.549l4.175,4.175c1.093-.464,1.825-1.543,1.825-2.761,0-1.654-1.346-3-3-3h-1v-2h1c2.757,0,5,2.243,5,5,0,1.759-.915,3.345-2.346,4.24l1.439,1.439c1.809-1.308,2.907-3.424,2.907-5.679,0-3.86-3.141-7-7-7h-1v-2h1c4.963,0,9,4.038,9,9,0,2.79-1.308,5.415-3.479,7.107Z"/>';
    } else {
        document.getElementById("Layer_1").innerHTML = '<path d="M2,6A2,2,0,0,0,0,8v8a2,2,0,0,0,2,2H4.8L12,23.977V.017L4.8,6Z"/><path d="M20,12a5.006,5.006,0,0,0-5-5H14V9h1a3,3,0,0,1,0,6H14v2h1A5.006,5.006,0,0,0,20,12Z"/><path d="M15,3H14V5h1a7,7,0,0,1,0,14H14v2h1A9,9,0,0,0,15,3Z"/>';
    }
};
